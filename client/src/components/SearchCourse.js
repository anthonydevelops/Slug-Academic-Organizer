        ...
        <span className="hits">
          ...
          <UncontrolledCollapse toggler={"#id" + this.props.hit.objectID}>
            ...
            <p>
              ...
              Days and Times:{" "}
              <Highlight
                attribute="lecture.days"
                hit={this.props.hit}
                tagName="mark"
              />{" "}
              <Highlight
                attribute="lecture.times"
                hit={this.props.hit}
                tagName="mark"
              />
              <br />
              ...
              Meeting Dates:{" "}
              <Highlight
                attribute="lecture.meetingDates"
                hit={this.props.hit}
                tagName="mark"
              />
            </p>
...
class SearchCourse extends Component {
  ...
  render() {
    return <App onClick={this.props.onSubmit} userID={this.props.userID} />;
  }
}
